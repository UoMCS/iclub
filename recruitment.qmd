...
We are one of the biggest department of Computer Science at the [Russell Group](https://www.russellgroup.ac.uk/) with a lots of students. As of 2026 we have around: 

* ~1000 students studying one of two main [undergraduate courses](https://www.cs.manchester.ac.uk/study/undergraduate/courses/):
    1. BSc (Hons) Computer Science 
    1. BSc (Hons) Computer Science with Mathematics

Both programs are avaialble *with Industrial Experience* (IE) Alongside our undergraduate community we currently have:
...
Around a third of our undergraduate students do a year in industry. For the academic year starting in  2025, we have 77 students starting a year long industrial experience (IE) placement as part of their degree.
...
* [MathSoc](https://manchesterstudentsunion.com/activities/view/mathsoc)
* Manchester Intelligence Society [MIS](https://manchesterstudentsunion.com/activities/view/manchester-intelligence)
...
A good way to collaborate with and recruit students is to sponsor and support student events by contacting relevant societies directly. This includes hackathons, talks, panels, workshops, insights and more. 

If you are recruiting computer scientists and software engineers as a summer interns, placement students or as graduates please get in touch. We typically have around 250 undergraduate students graduating annually, alongside a smaller number of Masters and PhD students. As of 2026, the [entry tariff](https://www.ucas.com/ucas/tariff-calculator) of our students (A* A* A* including mathematics) is comparable to other leading Computer Science (CS) departments in [Russell Group](https://en.wikipedia.org/wiki/Russell_Group) universities as shown in the table below.
